...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://designai.studio';

  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: 'weekly', priority: 1 },
    { url: `${baseUrl}/studio`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${baseUrl}/mobile`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
